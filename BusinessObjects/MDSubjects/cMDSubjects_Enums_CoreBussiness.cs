...
{
	[Serializable]
	public partial class cMDSubjects_Enums_CoreBussiness: CoreBusinessClass<cMDSubjects_Enums_CoreBussiness>
	{
        ...
        public static cMDSubjects_Enums_CoreBussiness NewMDSubjects_Enums_CoreBussiness()
        {
            return DataPortal.Create<cMDSubjects_Enums_CoreBussiness>();

        }

        public static cMDSubjects_Enums_CoreBussiness GetMDSubjects_Enums_CoreBussiness(int uniqueId)
        {
            return DataPortal.Fetch<cMDSubjects_Enums_CoreBussiness>(new SingleCriteria<cMDSubjects_Enums_CoreBussiness, int>(uniqueId));
        }

        internal static cMDSubjects_Enums_CoreBussiness GetMDSubjects_Enums_CoreBussiness(MDSubjects_Enums_CoreBussiness data)
        {
            return DataPortal.Fetch<cMDSubjects_Enums_CoreBussiness>(data);
        }
        ...
        private void DataPortal_Fetch(SingleCriteria<cMDSubjects_Enums_CoreBussiness, int> criteria)
        {
            using (var ctx = ObjectContextManager<MDSubjectsEntities>.GetManager("MDSubjectsEntities"))
            {
                var data = ctx.ObjectContext.MDSubjects_Enums_CoreBussiness.First(p => p.Id == criteria.Value);
        ...
        private void DataPortal_Fetch(MDSubjects_Enums_CoreBussiness data)
        {
        ...
        protected override void DataPortal_Insert()
        {
            using (var ctx = ObjectContextManager<MDSubjectsEntities>.GetManager("MDSubjectsEntities"))
            {
                var data = new MDSubjects_Enums_CoreBussiness();
                ...
                ctx.ObjectContext.AddToMDSubjects_Enums_CoreBussiness(data);
    ...
    public partial class cMDSubjects_Enums_CoreBussiness_List : BusinessListBase<cMDSubjects_Enums_CoreBussiness_List, cMDSubjects_Enums_CoreBussiness>
    {
        public static cMDSubjects_Enums_CoreBussiness_List GetcMDSubjects_Enums_CoreBussiness_List()
        {
            return DataPortal.Fetch<cMDSubjects_Enums_CoreBussiness_List>();
        }

        public static cMDSubjects_Enums_CoreBussiness_List GetcMDSubjects_Enums_CoreBussiness_List(int companyId, int includeInactiveId)
        {
            return DataPortal.Fetch<cMDSubjects_Enums_CoreBussiness_List>(new ActiveEnums_Criteria(companyId, includeInactiveId));
        }
        ...
        private void DataPortal_Fetch()
        {
            using (var ctx = ObjectContextManager<MDSubjectsEntities>.GetManager("MDSubjectsEntities"))
            {
                var result = ctx.ObjectContext.MDSubjects_Enums_CoreBussiness;

                foreach (var data in result)
                {
                    var obj = cMDSubjects_Enums_CoreBussiness.GetMDSubjects_Enums_CoreBussiness(data);
        ...
        private void DataPortal_Fetch(ActiveEnums_Criteria criteria)
        {
            using (var ctx = ObjectContextManager<MDSubjectsEntities>.GetManager("MDSubjectsEntities"))
            {
                var result = ctx.ObjectContext.MDSubjects_Enums_CoreBussiness.Where(p => (p.CompanyUsingServiceId == criteria.CompanyId || (p.CompanyUsingServiceId ?? 0) == 0) && ((p.Inactive ?? false) == false || p.Id == criteria.IncludeInactiveId));
