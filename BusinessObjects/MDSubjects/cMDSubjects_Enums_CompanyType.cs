...
{
	[Serializable]
	public partial class cMDSubjects_Enums_CompanyType: CoreBusinessClass<cMDSubjects_Enums_CompanyType>
	{
        ...
        public static cMDSubjects_Enums_CompanyType NewMDSubjects_Enums_CompanyType()
        {
            return DataPortal.Create<cMDSubjects_Enums_CompanyType>();

        }

        public static cMDSubjects_Enums_CompanyType GetMDSubjects_Enums_CompanyType(int uniqueId)
        {
            return DataPortal.Fetch<cMDSubjects_Enums_CompanyType>(new SingleCriteria<cMDSubjects_Enums_CompanyType, int>(uniqueId));
        }

        internal static cMDSubjects_Enums_CompanyType GetMDSubjects_Enums_CompanyType(MDSubjects_Enums_CompanyType data)
        {
            return DataPortal.Fetch<cMDSubjects_Enums_CompanyType>(data);
        }
        ...
        private void DataPortal_Fetch(SingleCriteria<cMDSubjects_Enums_CompanyType, int> criteria)
        {
            using (var ctx = ObjectContextManager<MDSubjectsEntities>.GetManager("MDSubjectsEntities"))
            {
                var data = ctx.ObjectContext.MDSubjects_Enums_CompanyType.First(p => p.Id == criteria.Value);
        ...
        private void DataPortal_Fetch(MDSubjects_Enums_CompanyType data)
        {
        ...
        protected override void DataPortal_Insert()
        {
            using (var ctx = ObjectContextManager<MDSubjectsEntities>.GetManager("MDSubjectsEntities"))
            {
                var data = new MDSubjects_Enums_CompanyType();
                ...
                ctx.ObjectContext.AddToMDSubjects_Enums_CompanyType(data);
    ...
    public partial class cMDSubjects_Enums_CompanyType_List : BusinessListBase<cMDSubjects_Enums_CompanyType_List, cMDSubjects_Enums_CompanyType>
    {
        public static cMDSubjects_Enums_CompanyType_List GetcMDSubjects_Enums_CompanyType_List()
        {
            return DataPortal.Fetch<cMDSubjects_Enums_CompanyType_List>();
        }

        public static cMDSubjects_Enums_CompanyType_List GetcMDSubjects_Enums_CompanyType_List(int companyId, int includeInactiveId)
        {
            return DataPortal.Fetch<cMDSubjects_Enums_CompanyType_List>(new ActiveEnums_Criteria(companyId, includeInactiveId));
        }
        ...
        private void DataPortal_Fetch()
        {
            using (var ctx = ObjectContextManager<MDSubjectsEntities>.GetManager("MDSubjectsEntities"))
            {
                var result = ctx.ObjectContext.MDSubjects_Enums_CompanyType;

                foreach (var data in result)
                {
                    var obj = cMDSubjects_Enums_CompanyType.GetMDSubjects_Enums_CompanyType(data);
        ...
        private void DataPortal_Fetch(ActiveEnums_Criteria criteria)
        {
            using (var ctx = ObjectContextManager<MDSubjectsEntities>.GetManager("MDSubjectsEntities"))
            {
                var result = ctx.ObjectContext.MDSubjects_Enums_CompanyType.Where(p => (p.CompanyUsingServiceId == criteria.CompanyId || (p.CompanyUsingServiceId ?? 0) == 0) && ((p.Inactive ?? false) == false || p.Id == criteria.IncludeInactiveId));
