...
namespace AlphaScoreModelBinder
{
    public class AlphaScoreModelBinder : DevExpressEditorsBinder
    {
         /// <summary>
      ...
      /// </summary>
        ...
        public AlphaScoreModelBinder(bool CheckRulesOnModelUpdated = true)
        {
        ...
        {
            if (propertyDescriptor.Name == "EntityKeyData")
            {
                //var enKey = propertyDescriptor;
                //return base.GetPropertyValue(controllerContext, bindingContext, propertyDescriptor, propertyBinder);
                return bindingContext.Model;
                //byte[] enKey = Convert.FromBase64String(propertyDescriptor.GetValue(propertyDescriptor.));
            }
            else
            {
