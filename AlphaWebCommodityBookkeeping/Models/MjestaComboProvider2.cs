...
namespace AlphaWebCommodityBookkeeping.Models
{
    ...
    public class MjestaComboProvider2
    {
        ...
        public static object GetPersonsRange(ListEditItemsRequestedByFilterConditionEventArgs args)
        {
            ...
            if (System.Web.HttpContext.Current.Session["listMjesta2"] != null)
                listForGrid = (List<int?>)System.Web.HttpContext.Current.Session["listMjesta2"];
            else
            ...
            else if (args.Filter == "" && listForGrid.Count > 0)
            {
                ...
                System.Web.HttpContext.Current.Session["listMjesta2"] = null;
                return rez;
