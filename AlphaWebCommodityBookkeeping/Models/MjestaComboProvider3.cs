...
namespace AlphaWebCommodityBookkeeping.Models
{
    ...
    public class MjestaComboProvider3
    {
        ...
        public static object GetPersonsRange(ListEditItemsRequestedByFilterConditionEventArgs args)
        {
            ...
            if (System.Web.HttpContext.Current.Session["listMjesta3"] != null)
                listForGrid = (List<int?>)System.Web.HttpContext.Current.Session["listMjesta3"];
            else
            ...
            else if (args.Filter == "" && listForGrid.Count > 0)
            {
                ...
                System.Web.HttpContext.Current.Session["listMjesta3"] = null;
                return rez;
